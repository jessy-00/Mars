[index.html](https://github.com/user-attachments/files/23855418/index.html)
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="app-container">
        ...
        <div class="input-section">
            ...
            <!-- 修改：删除90分钟套餐，更新其他套餐价格 -->
            <div class="package-buttons">
                <button class="package-btn" data-minutes="30">30分钟<br>6.00元</button>
                <button class="package-btn" data-minutes="60">60分钟<br>11.90元</button>
                <button class="package-btn" data-minutes="120">120分钟<br>22.90元</button>
            </div>
    ...
    <script>
        // 原有变量定义，修改PRICE_CONFIG配置
        let tasks = {};
        let completedTasks = [];
        
        // 修改：更新价格配置，删除90分钟套餐，金额保留两位小数
        let PRICE_CONFIG = {
            baseRate: 0.50, // 基础单价保留两位小数
            packages: {
                30: 6.00,
                60: 11.90,
                120: 22.90
        ...
        function bindEvents() {
            ...
            document.querySelectorAll('.package-btn').forEach(btn => {
                btn.addEventListener('click', function() {
                    ...
                    // 金额显示保留两位小数
                    showMessage(`已选择 ${selectedPackage} 分钟套餐，价格 ${pkgPrice.toFixed(2)} 元`, 'success');
                });
            });
        ...
        function startNewTask() {
            ...
            if (PRICE_CONFIG.packages[plannedMinutes]) {
                ...
                priceInfo = {
                    ...
                    description: `基础价（${plannedMinutes}分钟 × ${PRICE_CONFIG.baseRate.toFixed(2)}元/分钟）`,
                    isPackage: false
                };
            }
        ...
        function updateCompletedTasksDisplay(filteredTasks = null) {
            ...
            tasksToShow.forEach((task, index) => {
                ...
                if (task.overtime > 0) {
                    priceDetailsHtml += `
                        <div class="price-info">超时价格: ${task.price.overtimePrice}元（${task.price.overtimeMinutes}分钟 × ${PRICE_CONFIG.baseRate.toFixed(2)}元/分钟）</div>
        ...
        function savePriceSettings() {
            ...
            document.querySelectorAll('.package-btn').forEach(btn => {
                ...
                btn.innerHTML = `${minutes}分钟<br>${price}元`;
            });
